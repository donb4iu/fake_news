...
real = pd.read_csv('app/FakeNewsDetectionusingNLPtechniques/data/True.csv') # Replace with actual DataFrame
fake = pd.read_csv('app/FakeNewsDetectionusingNLPtechniques/data/Fake.csv')  # Replace with actual DataFrame
